...
output:
  html_document:
    ...
    highlight: tango
---
<!-- !!!!!TENER OJO CON EL YALM!!!! cualquier espacio o tab mal puesto no corre!--> 

[Ver la versión documento (.md) en GitHub](https://github.com/patosaid/apuntes_git_rmarkdown/blob/master/apuntes_git_rmarkdown.md)
...
2. Create a [Pull Request](https://help.github.com/en/articles/creating-a-pull-request) on GitHub.
